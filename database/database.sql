...
('usuario1', 'Juan Pérez', 'clave123'),  
('usuario2', 'María López', 'contraseña456')

INSERT INTO [dbo].[CATEGORIA_PRODUCTO]([NOMBRE]) VALUES ('Electrónica'), 
('Ropa'), ('Hogar')
...
INSERT INTO [dbo].[CARRITO_COMPRA]([FECHA], [ID_USUARIO]) VALUES ('2023-08-09', 1001), 
('2023-08-09', 1002)



INSERT INTO [dbo].[DETALLE_CARRITO]([CANTIDAD], [ID_PRODUCTO], [ID_CARRITO_COMPRA]) VALUES (2, 201, 1),
(3, 202, 2),
(1, 203, 1)
